...
import { useMergedRefs, useVideoElement, useVideoInteraction } from "@/hooks";
...
export default function VideoImage({
	...
	const videoSrc = getVideoPathFromThumbnail(thumbnailSrc);
		...
		>
			...
			{showVideo && (
				<video
					...
					src={videoSrc}
					className={cn(
						"absolute inset-0 w-full h-full object-cover aspect-video transition-opacity duration-300",
