...
export const metadata: Metadata = {
	title: "infinidream",
	description:
		"Discover and experience animated visuals from a multitude of styles and artists. Turn any screen into a digital painting, an ambience enhancer, a meditation machine, or an interactive installation.",
	icons: {
		icon: "/logo.png",
	},
